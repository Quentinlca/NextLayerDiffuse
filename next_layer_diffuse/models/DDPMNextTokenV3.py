...
class TrainingConfig:
    ...
    output_dir = "training_outputs/DDPMNextTokenV3"  # the model name locally and on the HF Hub
    backup_output_dir = "training_outputs/DDPMNextTokenV3_backup"  # the model name locally and on the HF Hub if push_to_hub fails
    push_to_hub = True  # whether to upload the saved model to the HF Hub
    hub_model_id = "QLeca/DDPMNextTokenV3"  # the name of the repository to create on the HF Hub
    wandb_project_name = "ddpm-next-token-v3"  # the name of the project on Weights & Biases
    seed = 0
